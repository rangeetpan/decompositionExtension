...
mn = MNISTUitl()
ru=Reuse()
#x_train = mnist.load_data('emnist-train-imgs.npz')
#x_test = mnist.load_data('emnist-test-imgs.npz')
#y_train = mnist.load_data('emnist-train-labels.npz')
#y_test = mnist.load_data('emnist-test-labels.npz')
...
for i in range(10):
    ...
    nm , xttt, yttt = mn.trainDense3(Xtt, Ytt, xtt,ytt,sx,sy,2,50)
