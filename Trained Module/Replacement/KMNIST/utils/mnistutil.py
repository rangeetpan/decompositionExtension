...
class MNISTUitl:
    ...
    def getdata2(self,a,b,img_rows = 28, img_cols = 28):
        x_train = self.load_data('kmnist-train-imgs.npz')
        x_test = self.load_data('kmnist-test-imgs.npz')
        y_train = self.load_data('kmnist-train-labels.npz')
#        for i in range(0,len(y_train)):
#            y_train[i]=y_train[i]-1
        y_test = self.load_data('kmnist-test-labels.npz')
